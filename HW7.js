## 習題：《狼、羊、甘藍菜》過河的問題 題目:有一個人帶著一匹狼、一頭羊和一棵甘藍菜打算過河到對岸去。他的船很小, 每次只能載兩個東西: 也就是 【人 + 狼】 【人 + 羊】, 或【人 + 甘藍菜】。 困難的地方是, 如果他先載了甘藍菜過去, 狼就會趁機把羊吃掉了。而如果他先把狼送過去, 羊也會趁他離開時把甘藍菜吃掉。 請問：他應該怎麼樣做才能夠把這二種動物和甘藍菜都送到對岸呢? 請找出運送順序！ 程式：請寫一個程式搜尋出這個問題的解答！ ### JavaScript 版參考實作 檔案： shipSearch.js
var c = console;
var objs = ["人", "狼", "羊", "菜"];
var state= [   0,  0 ,   0,    0 ];
